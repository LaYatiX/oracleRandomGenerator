...
import pl.grzegorz.config.audit.AuditEventConverter;
import pl.grzegorz.domain.PersistentAuditEvent;
...
import static pl.grzegorz.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
